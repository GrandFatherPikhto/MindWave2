...
static const char blankString[] = QT_TRANSLATE_NOOP("DialogSP", "N/A");
...
//            this, &DialogSP::showPortInfo);
//    connect(ui->baudRateBox,  QOverload<int>::of(&QComboBox::currentIndexChanged),
//            this, &DialogSP::checkCustomBaudRatePolicy);
//    connect(ui->serialPortInfoListBox, QOverload<int>::of(&QComboBox::currentIndexChanged),
//            this, &DialogSP::checkCustomDevicePathPolicy);
//
//    fillPortsParameters();
//    fillPortsInfo();
...
DialogSP::Settings DialogSP::settings() const
{
    return m_currentSettings;
}

void DialogSP::showPortInfo(int idx)
{
    if (idx == -1)
        return;
...
void DialogSP::checkCustomBaudRatePolicy(int idx) {
...
void DialogSP::checkCustomDevicePathPolicy(int idx) {
...
void DialogSP::fillPortsParameters() {
...
void DialogSP::loadSettings() {
//    QSettings settings(tr("RQD"), tr("MindWave"));
//    QString serialPortName = settings.value(tr("SerialPort/Name"), tr("ttyUSB0")).toString();
//    ui->serialPortInfoListBox->setCurrentText(serialPortName);
//    qDebug() << serialPortName;
}

void DialogSP::saveSettings() {
//    QSettings settings(tr("RQD"), tr("MindWave"));
//    settings.setValue(tr("SerialPort/Name"), m_currentSettings.name);
}
